...
- [단계별 성능 개선 과정](#-단계별-성능-개선-과정)
  - [1차 초기 상태](#1차-초기-상태)
  - [2차: Redis 캐싱 도입](#1차--2차-redis-캐싱-도입)
  - [3차: 댓글 로직 최적화](#3차-댓글-로직-최적화)
  - [4차: 로그 레벨 및 엔티티 최적화](#4차-로그-레벨-및-엔티티-최적화)
  - [5차: 커넥션 풀 및 엔티티 관계 최적화](#5차-커넥션-풀-및-엔티티-관계-최적화)
  - [6차: 시스템 설정 최적화](#6차-시스템-설정-최적화)
  - [7차: 로그인 아키텍처 개선](#7차-로그인-아키텍처-개선)
  - [8차: JSON 처리 및 쓰레드 풀 최적화](#8차-json-처리-및-쓰레드-풀-최적화)
- [결론 및 배운점](#-결론-및-배운점)
...
### 1차 초기 상태
- [📊 1차 테스트 결과.md](results%2Fphase1%2Fphase1-result.md)

### 1차 → 2차: Redis 캐싱 도입
- [📊 2차 테스트 결과.md](results%2Fphase2%2Fphase2-result.md)
...
### 3차: 댓글 로직 최적화
- [📊 3차 테스트 결과.md](results%2Fphase3%2Fphase3-result.md)
...
### 4차: 로그 레벨 및 엔티티 최적화
- [📊 4차 테스트 결과.md](results%2Fphase4%2Fphase4-result.md)
...
- [📊 5차 테스트 결과.md](results%2Fphase5%2Fphase5-result.md)
...
### 6차: 시스템 설정 최적화
- [📊 6차 테스트 결과.md](results%2Fphase6%2Fphase6-result.md)
...
### 7차: 로그인 아키텍처 개선
- [📊 7차 테스트 결과.md](results%2Fphase7%2Fphase7-result.md)
...
- [📊 8차 테스트 결과.md](results%2Fphase8%2Fphase8-result.md)
